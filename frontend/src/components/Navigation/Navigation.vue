...
<script type="text/javascript">
  ...
  export default {
    ...
    methods: {
      ...
      // TODO: Pass setBlur function as prop to Options.vue (if that's possibly), or do similar
      ...
      // TODO: Pass addClassToNotif function as prop to Options.vue (if that's possibly), or do similar
